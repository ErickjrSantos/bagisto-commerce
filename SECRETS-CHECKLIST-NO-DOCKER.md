# GitHub Secrets Checklist (No Docker Deployment)

This checklist is for the **non-Docker CI/CD deployment** workflow.

Go to: **Your Repo → Settings → Secrets and variables → Actions → New repository secret**

---

## ✅ VPS Connection (4 secrets) - **MAINTAINED**
...
## ✅ Application (3 secrets) - **MAINTAINED**
- [ ] `APP_NAME` - `Bagisto`
- [ ] `APP_KEY` - Your existing base64 key
- [ ] `APP_URL` - Your domain or `http://your-vps-ip`

## ✅ Database (5 secrets) - **UPDATED**
- [ ] `DB_HOST` - **NEW** - Database host (e.g., `localhost` or `127.0.0.1`)
- [ ] `DB_PORT` - **NEW** - Database port (usually `3306`)
- [ ] `DB_DATABASE` - **MAINTAINED** - Database name (e.g., `mutindo`)
- [ ] `DB_USERNAME` - **MAINTAINED** - Database user (e.g., `bagisto`)
- [ ] `DB_PASSWORD` - **MAINTAINED** - Database password
